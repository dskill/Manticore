...
public class ObjectPoolManager : MonoBehaviour
{
	...
	public static void Init( GameObject obj, int numToSpawn )
	{
		Instance.Initialize(obj, numToSpawn);
	}
	...
	private void Initialize( GameObject prefab, int numToSpawn )
	{
		ObjectPool pool;
		...
		if(pool.Count < numToSpawn)
			pool.Init( prefab, numToSpawn );
	}
